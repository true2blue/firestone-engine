...
start dist\calculate.exe 5da1800e87b64fb6f4c32503 --date 2019-10-30-m --hours %time:~0,2% --minutes * --seconds 2,5,8,11,14,17,20,23,26,29,32,35,38,41,44,47,50,53,56,59 -m -t -v -i
